(() => {
    ...
    const buildPiece = (product, index) => {
        ...
        const hanger = node("div", "piece__hanger");
        ...
        const plaque = node("div", "piece__plaque");
        const cta = node("span", "piece__cta");
        cta.append(
            document.createTextNode("Cotizar"),
            icon("icon-whatsapp", "piece__cta-icon")
        );
        ...
        frame.append(canvas);
        plaque.append(cta);
        link.append(hanger, frame, plaque);
        piece.append(link);
        return piece;
    };
